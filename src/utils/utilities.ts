...
*/
export function calculateTheHeadingDirection(deg: number): string {
  ...
  const index: number = Math.floor(deg / 22.5 + 0.5) % 16;
...
/**
  ...
  */
export function convertMPSToKPH(metersPerSecond: number): number {
